...
4. Перейдите в **Bot Settings** -> **Inline Mode**.
   ...
   ![](./kak-poluchit-ssylku-na-statyu-v-prilozhenii-vizi-4.jpeg){width=820px height=587px}

5. Нажмите **Turn on**.

   ![](./kak-poluchit-ssylku-na-statyu-v-prilozhenii-vizi-3.jpeg){width=824px height=341px}
...
1. **Начните диалог с ботом**:
   ...
   -  Напишите `/start` в чате с `@Egorova_Olga_Bot`.
      ...
      ![](./kak-poluchit-ssylku-na-statyu-v-prilozhenii-vizi-5.jpeg){width=578px height=470px}
...
2. **Активируйте Inline-поиск**:
   ...
   -  Появится список **внутренних страниц, товаров или визитки** бота.
      ...
      ![](./kak-poluchit-ssylku-na-statyu-v-prilozhenii-vizi-6.jpeg){width=573px height=479px}
...
3. **Выберите нужную ссылку**:
   ...
   -  Теперь её можно копировать и использовать где угодно.
      ...
      ![](./kak-poluchit-ssylku-na-statyu-v-prilozhenii-vizi-7.jpeg){width=576px height=474px}
