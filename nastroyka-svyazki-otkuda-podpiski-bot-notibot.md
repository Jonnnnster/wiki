...
3. **Автоматическое создание целей:**
   ...
   -  Появятся две цели:
      ...
      -  `user_did_subscribe` -- факт подписки в мини-приложение (главная цель).
...
1. **Настройте кампанию в Яндекс.Директ:**
   ...
   -  В целях выберите `user_did_subscribe` (подписка в мини-приложение).
...
-  Для глубоких целей (например, отправка формы или покупка) в Метрике создавайте цели типа **«JavaScript событие»** с параметром `order_id` или `form_id`.
