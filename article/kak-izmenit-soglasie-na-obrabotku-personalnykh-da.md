---
order: 3.4
title: Как изменить политику конфиденциальности в BotFather.
---
...
2. Отправьте команду `/mybots`. Вы увидите список ваших ботов.
   ...
   ![](./kak-izmenit-soglasie-na-obrabotku-personalnykh-da.jpeg){width=526px height=294px}
...
4. Перед вами откроется меню управления ботом. Нажмите `Edit bot`.
   ...
   ![](./kak-izmenit-soglasie-na-obrabotku-personalnykh-da-2.jpeg){width=536px height=342px}

5. В следующем меню выберите пункт  `Edit Privacy Policy`.

   ![](./kak-izmenit-soglasie-na-obrabotku-personalnykh-da-3.jpeg){width=533px height=468px}

6. BotFather предложит **прислать ссылку на вашу Политику конфиденциальности**.

   ![](./kak-izmenit-soglasie-na-obrabotku-personalnykh-da-4.jpeg){width=518px height=156px}
...
-  При первом запуске бота, рядом с кнопкой `START`, будет появляться надпись **"Политика конфиденциальности"**, ведущая на вашу страницу.
   ...
   ![](./kak-izmenit-soglasie-na-obrabotku-personalnykh-da-5.jpeg){width=398px height=332px}
